...
class StateMachineTest extends TestCase
{
    ...
    public function transitions()
    {
        ...
        $this->assertThat($this->actionCalls[0]['state'], $this->equalTo(StateMachineInterface::STATE_INITIAL));
        ...
        $this->assertThat($this->actionCalls[1]['event'], $this->equalTo(StateActionInterface::EVENT_ENTRY));
        ...
        $this->assertThat($this->actionCalls[2]['event'], $this->equalTo(StateActionInterface::EVENT_DO));
        ...
        $this->assertThat($this->actionCalls[3]['event'], $this->equalTo(StateActionInterface::EVENT_EXIT));
        ...
        $this->assertThat($this->actionCalls[5]['event'], $this->equalTo(StateActionInterface::EVENT_ENTRY));
        ...
        $this->assertThat($this->actionCalls[6]['event'], $this->equalTo(StateActionInterface::EVENT_DO));
    ...
    public function transitionsToTheNextStateWhenTheGuardConditionIsTrue()
    {
        ...
        $this->assertThat($this->actionCalls[4]['state'], $this->equalTo('Input'));
        $this->assertThat($this->actionCalls[4]['event'], $this->equalTo(StateActionInterface::EVENT_EXIT));
        $this->assertThat($this->actionCalls[4]['calledBy'], $this->equalTo('runAction'));
    }
    ...
    public function doesNotTransitionToTheNextStateWhenTheGuardConditionIsFalse()
    {
        ...
        $this->assertThat($this->actionCalls[3]['calledBy'], $this->equalTo('evaluateGuard'));
        $this->assertThat($this->actionCalls[4]['state'], $this->equalTo('Input'));
        $this->assertThat($this->actionCalls[4]['event'], $this->equalTo(StateActionInterface::EVENT_DO));
        $this->assertThat($this->actionCalls[4]['calledBy'], $this->equalTo('runAction'));
    }
